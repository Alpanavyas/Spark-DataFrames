...
spark.sql(""" 
 create external table cohort_c8.dyn_prtn_txn (txnno string, txndate string, 
...
terminated by ',' 
 ...
 location 'hdfs://localhost:9000/user/saif/HFS/Input//' 
 """)
...
partitionDf.write\
 ...
 .mode("overwrite")\
 .format("parquet")\
 .saveAsTable("cohort_c8.dyn_prtn_txn")
